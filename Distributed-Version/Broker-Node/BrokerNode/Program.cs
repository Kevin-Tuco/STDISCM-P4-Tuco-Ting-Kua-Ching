...
{
    new NodeStatus { Name = "View Node", Url = "http://localhost:5001", IsOnline = false, IsActivated = true, Latency = 0 },
    new NodeStatus { Name = "AuthController", Url = "http://localhost:5002", IsOnline = false, IsActivated = true, Latency = 0 },
    new NodeStatus { Name = "CoursesController", Url = "http://localhost:5003", IsOnline = false, IsActivated = true, Latency = 0 },
    new NodeStatus { Name = "GradesController", Url = "http://localhost:5004", IsOnline = false, IsActivated = true, Latency = 0 },
    new NodeStatus { Name = "ScheduleController", Url = "http://localhost:5005", IsOnline = false, IsActivated = true, Latency = 0 },
    
    // DB Nodes for Courses
    new NodeStatus { Name = "CoursesDb1", Url = "http://localhost:5006", IsOnline = false, IsActivated = true, Latency = 0 },
    new NodeStatus { Name = "CoursesDb2", Url = "http://localhost:5007", IsOnline = false, IsActivated = true, Latency = 0 },

    // DB Nodes for Grades
    new NodeStatus { Name = "GradesDb1", Url = "http://localhost:5008", IsOnline = false, IsActivated = true, Latency = 0 },
    new NodeStatus { Name = "GradesDb2", Url = "http://localhost:5009", IsOnline = false, IsActivated = true, Latency = 0 },

    // DB Nodes for Users
    new NodeStatus { Name = "UsersDb1", Url = "http://localhost:5010", IsOnline = false, IsActivated = true, Latency = 0 },
    new NodeStatus { Name = "UsersDb2", Url = "http://localhost:5011", IsOnline = false, IsActivated = true, Latency = 0 }
};
